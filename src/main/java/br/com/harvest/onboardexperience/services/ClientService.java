...
public class ClientService implements IService<ClientDto>{
	...
	public ClientDto create(@NonNull ClientDto dto) {
		try {
			...
			log.error("An error has occurred when saving client with CNPJ " + dto.getCnpj(), e);
			return null;
		}
	}
	...
	public ClientDto update(@NonNull final Long id, @NonNull ClientDto dto) {
		try {
			...
			log.error("An error has occurred when updating client with CNPJ " + dto.getCnpj(), e);
			return null;
		}
	}
	...
	public void delete(@NonNull final Long id) {
		try {
			...
			log.error("An error has occurred when deleting client with ID " + id, e);
		}
	}
	...
	public void disableClient(@NonNull final Long id) {
		try {
			...
			log.error("An error has occurred when disabling or enabling client with ID " + id, e);
		}
	}
	...
	public void expireClient(@NonNull final Long id) {
		try {
			...
			log.error("An error has occurred when expiring or reverting expiration from client with ID " + id, e);
		}
	}
	...
	public void blockClient(@NonNull final Long id) {
		try {
			...
			log.error("An error has occurred when blocking or disblocking client with ID " + id, e);
		}
	}
